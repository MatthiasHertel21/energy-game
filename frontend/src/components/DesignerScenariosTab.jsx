...
import { Box, Paper, Typography, Stack, TextField, Table, TableHead, TableRow, TableCell, TableBody, IconButton, Button, Dialog, DialogTitle, DialogContent, DialogActions, Chip, TablePagination, Tooltip } from '@mui/material'
...
export default function DesignerScenariosTab(){
