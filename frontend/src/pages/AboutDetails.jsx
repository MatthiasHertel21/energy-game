...
export default function AboutDetails() {
  ...
  const linkColor = theme.palette.mode === 'dark' ? theme.palette.primary.light : theme.palette.primary.main
  const partnersBg = theme.palette.mode === 'dark'
    ...
    <Container maxWidth="md" sx={{ mt: 4, mb: 4 }}>
      ...
      <Paper sx={{ p: 4 }}>
        ...
        <Typography variant="body1" paragraph sx={{ lineHeight: 1.8, mt: 3 }}>
          ...
          <a href="https://fastbreak.one" target="_blank" rel="noopener noreferrer" style={{ color: linkColor, fontWeight: 600 }}>
            Fastbreak.One
          </a>{' '}
          under the{' '}
          <a href="https://www.giz.de/en/worldwide/86454.html" target="_blank" rel="noopener noreferrer" style={{ color: linkColor, fontWeight: 600 }}>
            South African-German Energy Programme (SAGEN) | Capacities for the Energy Transition
          </a>
          , implemented by{' '}
          <a href="https://www.giz.de" target="_blank" rel="noopener noreferrer" style={{ color: linkColor, fontWeight: 600 }}>
            Deutsche Gesellschaft für Internationale Zusammenarbeit (GIZ) GmbH
          </a>{' '}
          and funded by the{' '}
          <a href="https://www.bmz.de" target="_blank" rel="noopener noreferrer" style={{ color: linkColor, fontWeight: 600 }}>
        ...
        <Box sx={{ mt: 4, p: 3, bgcolor: partnersBg, borderRadius: 2, border: '1px solid', borderColor: 'divider' }}>
          ...
          <Typography variant="body2" paragraph>
            <strong>
              <a href="https://fastbreak.one" target="_blank" rel="noopener noreferrer" style={{ color: linkColor }}>
                Fastbreak.One
              </a>
          ...
          <Typography variant="body2" paragraph>
            <strong>
              <a href="https://www.giz.de" target="_blank" rel="noopener noreferrer" style={{ color: linkColor }}>
          ...
          <Typography variant="body2" paragraph>
            <strong>
              <a href="https://www.bmz.de" target="_blank" rel="noopener noreferrer" style={{ color: linkColor }}>
          ...
          <Typography variant="body2" paragraph>
            <strong>
              <a href="https://www.giz.de/en/worldwide/86454.html" target="_blank" rel="noopener noreferrer" style={{ color: linkColor }}>
          ...
          <Typography variant="body2" paragraph>
            <strong>
              <a href="https://www.ntcsa.co.za" target="_blank" rel="noopener noreferrer" style={{ color: linkColor }}>
