"""Generate debug report for Session 371 Round 2"""
...
with app.app_context():
    ...
    result = Result.query.filter_by(session_id=371, player_id=1, round_num=2).first()
    forecast = Forecast.query.filter_by(session_id=371, player_id=1, round_num=2).first()
    ...
    import os
    print(f"   Size: {os.path.getsize(debug_file)/1024:.1f} KB")
